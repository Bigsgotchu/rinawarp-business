...
4. **Cloud Shell** (OCI's built-in terminal)
...
4. **Instance Discovery** - Can list and manage instances
5. **Image Discovery** - Latest Oracle Linux images available
...
2. **Set Up Bastion Service** for production access
   - More secure for production instances
   - Enables SSH without public IPs

3. **Use OCI Cloud Shell**
