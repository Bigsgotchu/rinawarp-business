...
4. **RinaWarp: Fix Selected Code** (`rinawarp.fixSelection`)
5. **RinaWarp: Voice Command** (`rinawarp.voiceCommand`) ✨ **NEW**
6. **RinaWarp: Execute Shell Command** (`rinawarp.executeShell`) ✨ **NEW**
7. **RinaWarp: Deploy Project** (`rinawarp.deploy`) ✨ **NEW**
8. **RinaWarp: Check Deploy Status** (`rinawarp.deployStatus`) ✨ **NEW**
...
4. Access control panel via sidebar
