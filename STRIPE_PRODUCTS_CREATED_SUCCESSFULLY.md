...
- **Date Created**: 2025-12-13T18:42:47Z
...
- **Metadata**: tier=basic, agent=limited, ai=limited, voice=false
...
- **Metadata**: tier=starter, agent=advanced, ai=standard, voice=false
- **Billing**: Monthly subscription
...
- **Metadata**: tier=creator, agent=fast, ai=high, voice=true
- **Billing**: Monthly subscription
...
- **Metadata**: tier=pro, agent=unlimited, ai=unlimited, voice=true
- **Billing**: Monthly subscription
...
- **Metadata**: tier=lifetime, level=founder, agent=full, ai=included, support=priority
...
- **Metadata**: tier=lifetime, level=pioneer, agent=full, ai=included, support=priority
- **Billing**: One-time payment (no recurring)
...
- **Metadata**: tier=lifetime, level=evergreen, agent=full, ai=included, support=standard
- **Billing**: One-time payment (no recurring)
...
- ✅ All products created in production mode

## Backend Entitlements Mapping

Your webhook + entitlements should map exactly:

```javascript
entitlements = {
  terminal: true,
  agent_level: 'basic' | 'starter' | 'creator' | 'pro' | 'lifetime',
...
```bash
# Product IDs
RINAWARP_BASIC_PRODUCT_ID=prod_TbA4GHQbUAWI5D
RINAWARP_STARTER_PRODUCT_ID=prod_TbA5D24sTqSV2m
RINAWARP_CREATOR_PRODUCT_ID=prod_TbA5j3tRuZhh4a
RINAWARP_PRO_PRODUCT_ID=prod_TbA54FTFeLSFN4
RINAWARP_FOUNDER_PRODUCT_ID=prod_TbA5JYP2dWBNzZ
RINAWARP_PIONEER_PRODUCT_ID=prod_TbA6yGiwQmKRXk
RINAWARP_EVERGREEN_PRODUCT_ID=prod_TbA6JPBxdf9VHZ

# Price IDs
RINAWARP_BASIC_PRICE_ID=price_1SdxksGZrRdZy3W9NSDRHfes
RINAWARP_STARTER_PRICE_ID=price_1Sdxl7GZrRdZy3W9INQvidPf
RINAWARP_CREATOR_PRICE_ID=price_1SdxlKGZrRdZy3W9TvaLugc7
RINAWARP_PRO_PRICE_ID=price_1SdxlXGZrRdZy3W9Wr1XLBIe
RINAWARP_FOUNDER_PRICE_ID=price_1SdxlmGZrRdZy3W9ncwPfgFr
RINAWARP_PIONEER_PRICE_ID=price_1Sdxm2GZrRdZy3W9C5tQcWiW
RINAWARP_EVERGREEN_PRICE_ID=price_1SdxmFGZrRdZy3W9skXi3jvE
```
...
This is exactly how serious SaaS tools launch. All products are live and ready for checkout integration.
