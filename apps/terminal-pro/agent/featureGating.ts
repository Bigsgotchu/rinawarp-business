...
export class FeatureGate {
  ...
  private isFeatureAccessible(feature: Feature): boolean {
    switch (feature.tier) {
      ...
      case Tier.TERMINAL_PRO:
        return this.entitlements.tier === Tier.TERMINAL_PRO || 
               this.entitlements.tier === Tier.AGENT_PRO;
  ...
  getAvailableFeatures(): Feature[] {
    return Object.values(FEATURES).filter(feature => 
      this.isFeatureAccessible(feature)
    );
  }
  ...
  getGatedFeatures(): Feature[] {
    return Object.values(FEATURES).filter(feature => 
      !this.isFeatureAccessible(feature) && feature.tier !== Tier.FREE
    );
  }
