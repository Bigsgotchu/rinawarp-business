...
class LongTermMemoryManager {
    constructor() {
        ...
        this.memoryFile = (0, path_1.join)(process.env.HOME || process.env.USERPROFILE || "/tmp", ".rina-agent-memory.json");
        this.loadMemory();
    }
    async loadMemory() {
        try {
    ...
    async saveMemory() {
        try {
            await (0, promises_1.writeFile)(this.memoryFile, JSON.stringify(this.memory, null, 2), "utf8");
        }
        catch (error) {
