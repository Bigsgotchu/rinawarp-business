...
export function registerFilesystemIpc(opts) {
    const { policy } = opts;
    ipcMain.handle('filesystem:readText', async (_e, input) => {
    ...
    ipcMain.handle('filesystem:writeText', async (_e, input) => {
    ...
    ipcMain.handle('filesystem:createDir', async (_e, input) => {
    ...
    ipcMain.handle('filesystem:delete', async (_e, input) => {
