...
export class LicenseHandler {
    ...
    async handleVerify(event, licenseKey) {
    ...
    async handleRefresh(event, licenseKey) {
    ...
    async handleGetPlan(event, licenseKey) {
    ...
    mapEntitlementToTier(entitlement) {
