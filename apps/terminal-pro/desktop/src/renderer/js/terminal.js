...
class TerminalManager {
    ...
    async loadAddon(addonName) {
        ...
        try {
            await this.loadScript(`https://cdn.jsdelivr.net/npm/xterm-addon-${addonName}@0.8.0/lib/xterm-addon-${addonName}.js`);
    ...
    createTerminal(options = {}) {
        ...
        // Create tab
        this.createTerminalTab(terminalId, terminal);
    ...
    createTerminalTab(terminalId, terminal) {
