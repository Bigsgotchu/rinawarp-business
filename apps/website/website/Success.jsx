      ...
      <div className="container">
        <div className="success-content">
          ...
          <p className="success-message">
            Thank you for your purchase! Your license has been activated and you can now download
            RinaWarp Terminal Pro with all premium features.
          </p>
          ...
          <div className="next-steps">
            <h3>What's Next?</h3>
            <ul>
              <li>📧 Check your email for your license key and setup instructions</li>
          ...
          <div className="support-section">
            ...
            <div className="support-links">
              <a href="mailto:support@rinawarptech.com" className="support-link">
