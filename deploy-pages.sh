...
if [ ! -d "dist-website" ]; then
  echo "❌ Error: dist-website directory not found. Please run this script from the project root."
  exit 1
fi
...
wrangler pages deploy dist-website --project-name=rinawarptech --commit-dirty=true
