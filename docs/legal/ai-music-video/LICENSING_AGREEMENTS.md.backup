# 📜 RinaWarp Technologies Licensing Agreements
...
2. **Software as a Service (SaaS) Agreement**
3. **Developer License Agreement**
...
Subject to the terms and conditions of this Agreement, RinaWarp Technologies, LLC ("Licensor") hereby grants to you ("Licensee") a limited, non-exclusive, non-transferable license to use the RinaWarp software products ("Software") solely for your internal business purposes.
...
SOFTWARE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.

### 6. LIMITATION OF LIABILITY

IN NO EVENT SHALL LICENSOR BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, OR USE, ARISING OUT OF OR IN CONNECTION WITH THE SOFTWARE.
...
Licensor provides cloud-based software services including:

- RinaWarp Terminal Pro (Terminal Emulation Service)
...
- Licensor will maintain appropriate security measures
...
- Licensee may access RinaWarp APIs for development purposes
...
- Licensee may resell RinaWarp products to end users
...
**These agreements are confidential and proprietary**
