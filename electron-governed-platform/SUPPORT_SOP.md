# Electron Governed Platform — Support SOP
...
~/.config/Electron Governed Platform/reports/
...
- log-tail.txt
- logs/
  - electron-governed-platform.log
  - electron-governed-platform.log.1 …
...
Read:
- `log-tail.txt`
- then full `electron-governed-platform.log`
