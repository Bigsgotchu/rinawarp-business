...
(function (window, document) {
  ...
  var TestimonialsWidget = {
    ...
    loadWidget: function(containerId) {
      ...
      var testimonialsGrid = document.createElement("div");
      testimonialsGrid.className = "rw-testimonials-grid";
      testimonialsGrid.setAttribute("data-animate", "");

      // Add testimonials
      this.testimonials.forEach(function(testimonial, index) {
        var testimonialEl = document.createElement("div");
  ...
  function init() {
    ...
    var testimonialsContainer = document.getElementById("rw-testimonials-widget");
