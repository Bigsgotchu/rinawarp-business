...
function showHelp() {
  ...
  console.log(chalk.cyan("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"));
  console.log(chalk.green("rw scan                 Scan repository for missing files, dist folders, and misconfigurations"));
  console.log(chalk.green("rw scan --fix           Auto-repair missing files and folders"));
  console.log(chalk.green("rw verify               Verify post-deploy health (website, API, auth)"));
  console.log(chalk.green("rw build [target]       Build applications (site, terminal, api, all)"));
  console.log(chalk.green("rw deploy [target]      Deploy to production (site, terminal, api, all)"));
  console.log(chalk.green("rw doctor               Deep system diagnostic"));
  console.log(chalk.green("rw generate [type] [name] Generate scaffolding (page, component, service)"));
  console.log(chalk.green("rw dev [target]         Start dev server (site, terminal, api, gateway, auth)"));
