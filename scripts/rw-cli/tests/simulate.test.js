...
describe("RW Agent Simulator", () => {
  it("should simulate agent behavior steps", () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining("Simulating RinaWarp Agent Behavior"));
    ...
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining("Agent executes action and returns response"));
