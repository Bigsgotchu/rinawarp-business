...
exports.analyzeLogsAI = analyzeLogsAI;
exports.generateIncidentResponse = generateIncidentResponse;
async function analyzeLogsAI(logs) {
    try {
...
async function generateIncidentResponse(incident, severity) {
    try {
        const response = `
...
function getSeverityActions(severity) {
    switch (severity) {
        case 'critical':
