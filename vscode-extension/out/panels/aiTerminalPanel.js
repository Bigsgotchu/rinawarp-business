...
exports.openAITerminal = openAITerminal;
...
function openAITerminal() {
    ...
    panel = vscode.window.createWebviewPanel('aiTerminal', 'AI Deployment Terminal', vscode.ViewColumn.One, { enableScripts: true });
...
function runCommandInTerminal(command) {
    const process = (0, child_process_1.spawn)('bash', ['-c', command], { cwd: vscode.workspace.workspaceFolders?.[0].uri.fsPath });
    let output = '';
...
//# sourceMappingURL=aiTerminalPanel.js.map